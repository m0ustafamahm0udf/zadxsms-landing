                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="about-exchange-thumb w-100 reveal-left pe-lg-4">
                            <img src="assets/img/about/about-exchange.png" alt="img" class="w-100">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="about-exchange-content">
                            ...
                            <div class="d-flex align-items-center gap-xl-4 gap-lg-3 gap-2 fadeInUp"
                                data-wow-delay=".5s">
                                <a href="about.html"
                                    class="common-btn box-style btn2 blackbg d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fw-500 white-clr py-3 overflow-hidden rounded100">
                                    Learn More
                                ...
                                <div class="d-flex align-items-center gap-xl-3 gap-sm-2 gap-1">
                                    <a href="https://www.youtube.com/watch?v=lMJImKo-eZU"
                                        class="cmn-video rounded-circle d-center video-popup">
                                        <i class="fa-solid fa-play"></i>
                                    </a>
                                    <span class="fs-seven fw-500 black-clr">How It Works</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="tv-section fix section-padding">
            <div class="container">
                ...
                <div class="tv-wrapper">
                    <div class="tv-items wow fadeInUp" data-wow-delay=".3s">
                        <img src="assets/img/brand/slack.png" alt="img">
                    </div>
                    <div class="tv-items wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/brand/dropbox.png" alt="img">
                    </div>
                    <div class="tv-items wow fadeInUp" data-wow-delay=".7s">
                        <img src="assets/img/brand/spotify.png" alt="img">
                    </div>
                    <div class="tv-items wow fadeInUp" data-wow-delay=".9s">
                        <img src="assets/img/brand/gizmado.png" alt="img">
                    </div>
                    <div class="tv-items wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/img/brand/dropbox2.png" alt="img">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="process-wrap">
                    ...
                    <div class="process-item d-md-flex d-grid gap-3 align-items-center justify-content-between wow fadeInUp"
                        ...
                        <div class="content d-lg-flex d-grid gap-2 align-items-center justify-content-between">
                            ...
                            <h3>
                                <a href="#0">Talk to us &amp; pick a plan</a>
                            </h3>
                        </div>
                        <div class="process-pra">
                            <a href="#0" class="arrow d-center rounded-circle p1-bg">
                    ...
                    <div class="process-item d-md-flex d-grid gap-3 align-items-center justify-content-between wow fadeInUp"
                        ...
                        <div class="content d-lg-flex d-grid gap-2 align-items-center justify-content-between">
                            ...
                            <h3>
                                <a href="#0">Activate &amp; start sending</a>
                            </h3>
                        </div>
                        <div class="process-pra">
                            <a href="#0" class="arrow d-center rounded-circle p1-bg">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="faq-thumb1 w-100 reveal-left">
                            <img src="assets/img/global/faq-thumb1.jpg" alt="img" class="rounded-4 w-100">
                        </div>
                    </div>
                </div>
            </div>
